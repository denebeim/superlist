...
class SendLoginEmailViewTest(TestCase):
    ...
    def test_redirects_to_home_page(self):
        response = self.client.post(
            ...
            data={'email': WILLING_TEST_SUBJECT}
        )
    ...
    def test_sends_mail_to_address_from_post(self, mock_send_mail):
        self.client.post(
            '/accounts/send_login_email', data={'email': WILLING_TEST_SUBJECT}
        )
        ...
        self.assertEqual(to_list, [WILLING_TEST_SUBJECT])
...
class LoginViewTest(TestCase):
    ...
    def test_creates_token_associated_with_email(self, mock_auth):
        ...
        self.assertEqual(token.email, WILLING_TEST_SUBJECT)
